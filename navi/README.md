...
- 기본 LLM 공급자/모델: `NAVI_LLM_PROVIDER=openrouter`,
  `OPENROUTER_LLM_MODEL=google/gemma-4-31b-it:free`
- 무료 fallback: `OPENROUTER_LLM_FALLBACK_MODELS=google/gemma-4-26b-a4b-it:free`
- OpenRouter OpenAI-compatible endpoint: `https://openrouter.ai/api/v1`
- Vercel AI Gateway 호환 경로와 `AI_GATEWAY_API_KEY` 설정은 복구용으로 보존합니다.
